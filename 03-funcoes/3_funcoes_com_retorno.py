...
# Vamos refatorar (Redifinir) essa função para que ela retorne o valor 
...
3 - Podemos, em uma função retornar qualquer tipo de dados, até mesmo múltiplos valores;
...
# Exemplo 3 - Podemos, em uma função retornar qualquer tipo de dados, até mesmo múltiplos valores.
def outra_funcao():
    return 2, 3, 4, 5
...
#def joga_moeda():
   # Gera um número pseudo-randômico(aleatoriedade) entre 0 e 1
   # valor = random()
   # if valor > 0.5:
   #     return 'Cara'
   # return 'Coroa'
...
# from 3_funcoes_com_retorno import joga_moeda
